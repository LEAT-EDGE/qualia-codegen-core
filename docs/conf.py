...
# This is used by qualia_codegen_core.typing.TYPE_CHECKING to enable TYPE_CHECKING blocks for autodoc in order to get the most type
# references possible
...
def run_apidoc(_: sphinx.application.Sphinx) -> int:
    ...
    return main(['-e',
          ...
          str(root_path/'src'/'qualia_codegen_core'),
          '--force'])
