            ...
            if node.layer.name in activations_range:
                ...
                if nextnode.layer.name in activations_range:
                    ...
                    node.q = Quantization(
                            ...
                            width=width,
                            long_width=long_width,
                            weights_width=activations_range[nextnode.layer.name].weights_bits,
                            bias_width=activations_range[nextnode.layer.name].bias_bits,
                            output_width=activations_range[nextnode.layer.name].activation_bits,
