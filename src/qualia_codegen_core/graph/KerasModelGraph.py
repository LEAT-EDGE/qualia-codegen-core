...
class KerasModelGraph(ModelGraph):
    MAPPING: ClassVar[dict[type[Layer], Callable[[Layer, TBaseLayer], tuple[type[TBaseLayer], list[Any]]]]] = {
        ...
        GlobalAveragePooling1D: lambda _, args: (TAvgPooling1DLayer, [TActivation.LINEAR,
                                                                      (args.input_shape[0][-2], ),
                                                                      (args.input_shape[0][-2], )]),
        GlobalAveragePooling2D: lambda _, args: (TAvgPooling2DLayer, [TActivation.LINEAR,
                                                                      (args.input_shape[0][-3], args.input_shape[0][-2]),
                                                                      (args.input_shape[0][-3], args.input_shape[0][-2])]),
