...
class Quantization:
    ...
    width: int | None = None  # Width for output, bias and weights
    long_width: int | None = None  # Width for temporary computation in C code

    weights_width: int | None = None  # Not used in C code
    bias_width: int | None = None  # Not used in C code
    output_width: int | None = None  # Not used in C code
